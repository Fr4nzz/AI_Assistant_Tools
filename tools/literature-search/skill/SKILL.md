...
4. Exa search, if installed/configured: experimental fourth source for
   neural/web search comparison.

If time or accounts are limited, use native search first and add Parallel or
paper-search only when the topic is broad, high stakes, or the user explicitly
wants a more exhaustive search.
