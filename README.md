...
2. Ask which tools to install: `gogcli`, `outlook`, `onedrive`, `d2l`, `whatsapp`, `humanizer`, `paper-fetch`, `literature-search`, `citation-zotero`, `scientific-writing`, `literature-appraisal`, or `all`.
